...
from stack_to_chunk.main import copy_to_zarr, create_group, downsample_group
...
if __name__ == "__main__":
    ...
    # copy_to_zarr(stack, group=group, chunk_size=64, compressor=Zstd(level=6), n_processes=1)
